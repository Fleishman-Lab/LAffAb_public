...
## Running LAffAb
A flags file is provided called "flags". The rosetta database needs to be updated to the location of the rosetta database corresponding to the Rosetta executable used. 
